...
export const navGroups: NavGroup[] = [
  {
    ...
    items: [
      ...
      { label: 'Planos B', href: '/contingencia', icon: ShieldAlert },
    ],
  },
  {
    title: 'Convidados',
    items: [
      { label: 'Lista e RSVP', href: '/convidados', icon: Users },
      { label: 'Lua de mel e pós', href: '/pos-casamento', icon: Plane },
    ],
  },
  {
    title: 'Financeiro',
  ...
  },
  {
    ...
    items: [
      ...
      { label: 'Papelaria e convites', href: '/papelaria', icon: Send },
      { label: 'Vestuário e beleza', href: '/vestuario', icon: Shirt },
      { label: 'Decoração e flores', href: '/decoracao', icon: Flower2 },
    ],
  },
  {
    title: 'Dia do Evento',
    items: [
      ...
      { label: 'Cerimônia e recepção', href: '/evento', icon: Utensils },
  ...
  {
    title: 'Site e detalhes',
    items: [
      { label: 'Site do casal', href: '/site', icon: Globe },
